...
This is a plugin for fluentd[http://github.com/fluent/fluentd] event collector.  This plugin adds the Flume[https://github.com/apache/flume] compatible interface to fluentd.
